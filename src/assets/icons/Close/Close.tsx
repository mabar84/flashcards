...
export const Close = (props: Props) => {
  const { disabled, handleClickClose, isError, ...otherProps } = props

  const cl = {
    close: clsx(s.close, isError && s.close_error),
  }
